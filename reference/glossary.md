...
| **Risk heatmap** | The table at the start of [Step 3](../assess/3-assess-risks.md#find-the-risks-that-matter) showing which of the eight risks typically matter most for each use type. A starting point for where to spend effort, not a set of ratings. |
